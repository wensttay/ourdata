...
public class KeyTime {
    ...
    private RowPeriod period;
    private String idResource;

    public KeyTime() {
    }

    public KeyTime(int repeatNumber, int rowsNumber, Timestamp metadataCreated, RowPeriod period, String idResource) {
    ...
    public RowPeriod getPeriod() {
        return period;
    }

    public void setPeriod(RowPeriod period) {
        this.period = period;
    }
